...
public class GridExporter<T> implements Serializable {
   ...
   * @since 2.6.0
   */
  public DownloadHandler getDocxDownloadHandler() {
   ...
   * @since 2.6.0
   */
  public DownloadHandler getDocxDownloadHandler(String template) {
   ...
   * @since 2.6.0
   */
  public DownloadHandler getPdfDownloadHandler() {
   ...
   * @since 2.6.0
   */
  public DownloadHandler getPdfDownloadHandler(String template) {
    return makeConcurrentDownloadHandler(
   ...
   * @since 2.6.0
   */
  public DownloadHandler getExcelDownloadHandler() {
   ...
   * @since 2.6.0
   */
  public DownloadHandler getExcelDownloadHandler(String template) {
    return makeConcurrentDownloadHandler(
